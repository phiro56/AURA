...
This document defines the AURA protocol for specifying AI agent personality.

---

## 1. Overview

AURA is a YAML-based configuration format for defining AI agent personality traits. It is:
